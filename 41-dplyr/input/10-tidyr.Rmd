...
This data frame stores two types of observational units in the same table. Variables `country`, `country` and `km3` refer to the first type of observational unit. The number of events: `event` per year: `year` by `state` refer to a second type of observational unit.
