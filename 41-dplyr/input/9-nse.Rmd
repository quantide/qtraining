...
On the other hand, NSE is is hard to program with.
...
You may want to mix constant and variable in the same call: that is the variable and the function are passed as arguments.
