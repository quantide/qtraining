...
that returns a data frame of quatiles along with the corresponding probabilities
...
Function `do()` can manage functions that return results of any length. Similarly, the same function can help when applying multile functions to the same variable.  
...
By using this propriety of data frames, you can compute a liner model on data frame `people` for any level of factor `Gender`:
