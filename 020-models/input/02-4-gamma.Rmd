...
The plot just created compare points arising from linear models with the same deterministic component, but the former with Gaussian error distribution, while the latter with Gamma error distribution and identity link.
