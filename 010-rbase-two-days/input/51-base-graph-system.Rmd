---
title: "Standard R graphical system"
output:
  html_document
---
...
R comes with a wide variety of graphical functions. The R default graphics package provide standard R graphics. Additional libraries such as `lattice` provide specialized and often very attractive graphics. This chapter is mainly about classical R graphics. Introductory examples of `lattice` graphics will be provided at the end of this chapter. 
...
\begin{center}
  \begin{tabular}{lll}
    & &  \\
    \hline
    \verb|"topleft"| & \verb|"top"| & \verb|"topright"| \\
    \verb|"left"| & \verb|"center"| & \verb|"right"|\\
    \verb|"bottomleft"| & \verb|"bottom"| & \verb|"bottomright"| \\
    \hline
  \end{tabular}
\end{center}
...
```{r, nclass, fig=TRUE, width=8, height=8}
par(mfrow = c(1, 2))
with (cars, {
  hist(dist, nclass = 12,
