...
.pkgs <- c("ggplot2", "lattice", "mnormt")
.load <- lapply(.pkgs, FUN=function(x) {if(!require(x, character.only=TRUE)) {install.packages(x)}; library(x, character.only=TRUE); cat(x, "package loaded \n")})
```
