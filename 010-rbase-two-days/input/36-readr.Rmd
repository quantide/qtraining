...
In this chapter  you'll learn how to import flat files in `tidyverse`. You will do this with the use of `readr` package which is part of the `tidyverse` core. 

As already learned, if you load the package `tidyverse`, `readr` will automatically be loaded:
...
Variable types available in `R` are:
