...
![<small>Screenshot of the R-project website\label{fig:ssSiteRproject}</small>](./images/r-project.png)
...
![<small>Screenshot of a first try with R\label{fig:ssFirsttry}</small>](./images/RfirstPlot.png)
...
![<small>R Default Interfaces</small>](images/ssDefaultGui.png)
...
![<small>Screenshot of an RStudio session</small>](images/ssGuiRstudio.png)
...
![<small>JGR Interface</small>](images/ssGuiJgr.png)

**Tinn-R** is one of the most used R editor by Windows users. It includes R syntax highlighting, help on R functions syntax while you type them, direct submission of R code and many other tools to control R from within the editor.

![<small>Tinn-R Interface</small>](images/ssGuiTinnr.jpg)
...
![<small>Emacs, VIM, Eclipse and Komodo Interfaces</small>](images/ssGuiEmacs.png)
...
![<small>Deducer, R-Commander and Red-R Interfaces</small>](images/ssGuiDeducer.png)
...
![<small>R packages universe</small>](./images/r-packages-universe.png)
