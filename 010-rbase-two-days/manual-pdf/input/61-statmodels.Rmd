...
include_graphics("images/flow-dtanal.png", dpi=170)
```
...
```{r drugplot, fig = TRUE, fig.width=4, fig.height=3.5}
...
```{r, carseatplot, fig = TRUE, fig.width=4, fig.height=3.5}
...
```{r, residualscarseat, fig = T, fig.width=4, fig.height=3.5}
par(mfrow = c(1,2))
plot(fm, which = 1:2)
```
...
```{r, boilingxyplot, fig=T, fig.width=4, fig.height=3.5}
