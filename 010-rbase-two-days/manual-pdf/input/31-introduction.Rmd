...
include_graphics("images/flow-robj.png", dpi=170)
```
...
include_graphics("images/import-text-2.png", dpi=150)
```
...
```{r g3, echo=FALSE, fig.width=6, purl=FALSE}
include_graphics("images/excel-emptySheet.png", dpi=200)
```
...
```{r g4, echo=FALSE, fig.width=3, purl=FALSE}
include_graphics("images/excel-inputSheet.png", dpi=150)
```
...
```{r g5, echo=FALSE, fig.width=3, purl=FALSE}
include_graphics("images/excel-airqualitySheet.png", dpi=150)
```
...
```{r g6, echo=FALSE, fig.width=4, purl=FALSE}
include_graphics("images/excel-addFormula.png", dpi=150)
```
...
```{r g7, echo=FALSE, fig.width=6, purl=FALSE}
include_graphics("images/excel-ozonePlot.png", dpi=200)
```
