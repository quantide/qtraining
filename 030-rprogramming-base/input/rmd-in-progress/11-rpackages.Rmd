...
You can use the tag `@importFrom` to highlight functions that are imported from other packages: for instance, as we will see in the next chapter:
...
A vignette is a document that provides a general overview of your package. While the object documentation provides a punctual guide to 
