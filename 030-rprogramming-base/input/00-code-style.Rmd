...
When you are programming you should choose the style you feel the most comfortable with, however it is important that you stick with it when you write your code. Here we present one of the possible styles one may choose and it is the style this manual is adopting. It is based on [the tidyverse style guide]( http://style.tidyverse.org/) by Hadley Wickham; most of the examples in this chapter are taken from it.
