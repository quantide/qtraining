...
For example, you may take a look at some of the test functions of the package `stringr`:
...
So let us go back to our example ...
...
Now that you have learnt some more about the principles of testing and about how to write a test, we will guide you through inserting tests into your `R` package.

First yuo need to set up your package to use `testthat`:
...
Let us see all this with the usual example:

<!---
aggiungere esempio pacchetto di giuseppe
-->
