...
When a function is defined within a package, the environment associated to that package:

```{r functions-environment-package}
environment(mean)
```

Morover objects defined within a function, exists in the environment of the function itself.
...
For more details on the environment of a function, please see the web book Ramarro by Andrea Spanò.
