...
The syntax is quite simple. The function `ggplot()` initializes the plot with the following parameters: the _data_ is in the `bands` data frame and you _map_ the data to _aesthetics_ (visual properties) of plot like follow: the _x_-axis displays the `humidity` variable and the _y_-axis displays the `viscosity` variable. Note that the variable names must be unquoted.
