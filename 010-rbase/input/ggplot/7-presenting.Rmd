...
<!--
# Integrating R code and presentation: the R Markdown way

According to its authors, R Markdown is _an authoring format that enables easy creation of dynamic documents, presentations, and reports from R. It combines the core syntax of markdown (an easy to write plain text format) with embedded R code chunks that are run so their output can be included in the final document._

This section cannot provide a full introduction to R Markdown. If you are new to R Markdown, you can start from the [official website](http://rmarkdown.rstudio.com/). If you already know R Markdown, you will find here some guideline to manage plots in your reports.
