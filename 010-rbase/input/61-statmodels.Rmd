...
In R data can be analysed by regression models. In particular, regression models is an analysis that attempts to determine the strength of the relationship between one dependent variable, $y$, and a series of other changing variables, $x$. 
...
The `lm` and `aov` functions are used in R to fit respectively linear regression and analysis of variance models and their syntax is:
...
As a result, a generalized linear model with family Gamma and link identity can be used:
