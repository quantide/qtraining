...
```
Suppose that your current directory is the previous (set to "Data" folder) one and you want to set the directory on "Statistics" folder inside "Data" folder. 
...
Suppose that your current directory is the previous one (set to "Statistics" folder) and you want to set the directory on "Maths" folder inside "Data" folder.
