...
b. (3 pt) Build a scatterplot to analyze the relationship between `mpg` and `wt` variables. Use `geom_point()` function.
...
c. (3 pt) Represent the distribution of `mpg` variable with an histogram. Use `geom_histogram()` function.
