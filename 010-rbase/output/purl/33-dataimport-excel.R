## ----require_XLConnect, message=FALSE------------------------------------
require(XLConnect)
...
## ----add_plot, comment=FALSE,warning=FALSE, message=FALSE----------------
require(ggplot2)
