...
```{r, drugplot, fig = TRUE, fig.height=6.5}
...
```{r, predictionplot, fig = T, fig.height=6.5}
...
```{r, carseatplot, fig = TRUE, fig.height=6.5}
...
```{r, residualscarseat, fig = T, fig.height=6.5}
par(mfrow = c(1,2))
plot(fm, which = 1:2)
```
...
```{r, boilingxyplot, fig=T, fig.height=6.5}
library(lattice)
