...
A Shiny application is no more then an RScript. So in the global part we open the Spark Context, and read the data. The aggregation of data depends from an UI input, so it has been placed in the Server function, because it is re-calculated each time the input changes.
