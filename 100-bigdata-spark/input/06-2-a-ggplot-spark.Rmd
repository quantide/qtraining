...
Everytime `ggplot` is used with a lazy dataset it automatically try to collect it. So the dataset object have to be an aggregate or filtered product of the original dataset.
