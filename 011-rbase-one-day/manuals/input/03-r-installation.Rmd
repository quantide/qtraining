---
title: "R and R-Studio installation and configuration"
---
...
![<small>Screenshot of the R-project website</small>\label{fig:ssSiteRproject}](./images/r-project.png)
...
Windows users click on _base_ and then click _Download R X.X.X for Windows_.
...
![<small>Screenshot of a first try with R</small>\label{fig:ssFirsttry}](./images/RfirstPlot.png)
