---
title: "R and a bit of history"
---

```{r setup, include=FALSE, purl=FALSE, message=FALSE}
require(knitr)
opts_chunk$set(echo = TRUE, fig.widht = 4, fig.height= 3.5)
```
...
![<small>Source: [www.r4stats.com/2015/10/13/rexer-analytics-survey-results](http://r4stats.com/2015/10/13/rexer-analytics-survey-results/)</small>](./images/r-popularity.png)

Moreover, the number of companies using R is grown all over the world:

![<small>Source: [blog.revolutionanalytics.com](http://blog.revolutionanalytics.com/)</small>](./images/company-using-r.png)
