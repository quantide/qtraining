...
\begin{figure}
\includegraphics[width=6.92in]{./images/dataStructure} \caption{Source:  venus.ifca.unican.es/Rintro/dataStruct.html}\label{fig:g1}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=3.97in]{images/nnet} \caption{Neural Network scheme}\label{fig:g2}
\end{figure}
