...
require(knitr)
opts_chunk$set(echo = TRUE, fig.widht = 4, fig.height= 3.5, fig.align='center')
```
...
include_graphics("images/s-rev.png", dpi=150)
```
...
include_graphics("images/s+.png", dpi=150)
```
...
include_graphics("images/r.png", dpi=150)
```
...
```{r g5, echo=FALSE, purl=FALSE, fig.cap="Source: r4stats.com/2015/10/13/rexer-analytics-survey-results"}
include_graphics("images/r-popularity.png", dpi=150)
```


Moreover, the number of companies using R is grown all over the world:

```{r g6, echo=FALSE, purl=FALSE, fig.cap="Source: blog.revolutionanalytics.com"}
include_graphics("images/company-using-r.png", dpi=150)
```
