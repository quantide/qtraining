...
require(knitr)
opts_chunk$set(echo = TRUE, fig.align='center', fig.pos='h')
```
...
```{r g1, echo=FALSE, purl=FALSE, fig.cap= "Screenshot of www.r-project.org"}
...
```{r g2, echo=FALSE, purl=FALSE, fig.cap= "Screenshot of a first try with R"}
...
```{r g3, echo=FALSE, purl=FALSE, fig.cap= "R Default Interfaces"}
...
```{r g4, echo=FALSE, purl=FALSE, fig.cap= "Screenshot of an RStudio session"}
...
```{r g5, echo=FALSE, purl=FALSE, fig.cap= "R packages universe"}
