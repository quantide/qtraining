...
```{r g5, echo=FALSE, purl=FALSE, fig.cap="Source: www.r4stats.com/2015/10/13/rexer-analytics-survey-results"}
...
```{r g6, echo=FALSE, purl=FALSE, fig.cap="Source: www.blog.revolutionanalytics.com"}
