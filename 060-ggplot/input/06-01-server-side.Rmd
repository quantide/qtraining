...
Reall that we have 3 inputs: genderInput, alignInput, and yearInput. We will filter the data based on the values of these three inputs. We’ll use `dplyr` functions to filter the data and then we will simply plot the filtered data instead of the original data. Your server function should now look like this:
