...
The scheme must be read from down to top. Starting from down, the first three building blocks (Data, Aestethic Mappings and Layers) are essential to build a simple plot, meanwhile the remaining (Scales, Coordinates, Facet and Theme) allows us to build a complex plot and to customize it. The scheme order is recommended but it is not compulsory. 
