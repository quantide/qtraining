...
The data folder contains the dataset `marvel-wikia-data.csv`. Using `readr` package, load the dataset as this is the data we'll work on to build our shiny app:
