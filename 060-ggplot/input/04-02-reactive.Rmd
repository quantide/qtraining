...
* the _ui_ contains the functions that show the layout of the app and that allow you to interact with the app, here you need to indicate where you want your plot to be showed, if you want to include a drop down menu, etc
