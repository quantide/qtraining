...
Boxplot summarises the bulk of distributions with only five numbers: median, first quartile, third quartile, minimum and maximum. You can also add points to boxplots by using `geom_jitter()` function:
...
x-axis tick marker and label are removed by using `theme()` function. We remind the functionalities and features of these functions to the chapters of "Advanced ggplot2" section.  
