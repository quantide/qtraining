...
Some of the data that will be used in this exercises are contained in the data folder. Hence you should set your working directory in the _data_ folder, using `setwd()` function, like in this example:
...
```{r, echo=show_solution, eval=TRUE}
load("marks.Rdata")
```
