...
heartrate <- data.frame(
  ...
  morning = c(67, 80, 64, 56, 90, 50, 60, 85)
)
```
...
### Exercise 3
Import the data "heartrate_NA.Rdata". Consider all the missing values you find and replace them using the function `fill()` when possible.

```{r echo=show_solution, eval=show_solution}
heartrate_NA %>% fill(name, surname)
```
