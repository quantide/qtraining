...
```{r first2, include=TRUE, purl=TRUE, message=FALSE}
require(lubridate)
require(dplyr)
require(ggplot2)
require(tidyr)
...
Among packages that deal with dates and times in R, `lubridate` provides a set of intuitive and coherent functions. Intuitive since each function usually perform a single task described by its name; coherent since `lubridate` is part of tidyverse thus well integrated with the rest of it.
