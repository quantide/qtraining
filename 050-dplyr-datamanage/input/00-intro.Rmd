...
This course provides an overview of data management with `R`. Most of the packages that will be used in the course are part of the so-called "tidyverse". Packages in the tidyverse are packages that share a common philosophy of data management and that are designed to work well together (tidyverse.org). Please check out the manifesto for further details on the philosophy underlining tidyiverse:  [the tidy tools manifesto](https://cran.r-project.org/web/packages/tidyverse/vignettes/manifesto.html). 

The whole tidyverse can be installed with the following single (yet for long runnning!) line command.
