...
This course provides an overview of data management with `R`. Most of the packages that will be used in the course are part of the so-called "tidyverse". 

![<small>Some of the tidyverse packages. Source: www.tidyverse.org</small>](./images/tidyverse.png)

Packages in the tidyverse are packages that share a common philosophy of data management and that are designed to work well together (tidyverse.org). 
