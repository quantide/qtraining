...
In this chapter you will learn about string manipulation in `R` with the package `stringr`. You don't always work with textual data, hence `stringr` is not part part of the tidyverse core.
