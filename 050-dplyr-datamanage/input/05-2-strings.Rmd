...
Suppose you do not need to have each word stored separately. Hence you would like to "combine" them into the same string:
...
To let `R` know that it is not 4 different cities, you may give them the same name by taking the first two letters of each "provincia":
