...
Nella sezione "body" aggiungerei due righe su "expression".
Nella sezione "environment altre due righe su "local".

Nella sezione "operators" aggiungerei un paio di esempi avanzati
tratti dal package "lambda.R".

Terminerei il capitolo con un accenno avanzato a "closure", "Y
combinator" e lint in R:

http://rosettacode.org/wiki/Y_combinator#R
