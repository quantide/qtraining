...
if (!("parallel" %in% installed.packages()[,1])){install.packages ("parallel", repos="http://cran.rstudio.com/")}
if (!("foreach" %in% installed.packages()[,1])){install.packages ("foreach", repos="http://cran.rstudio.com/")}
if (!("doMC" %in% installed.packages()[,1])){install.packages ("doMC", repos="http://cran.rstudio.com/")}
...
## ----parallel-024, label="fxx2", error=TRUE------------------------------
cluster <-  makeCluster(2)
