...
```{r g3, echo=FALSE, purl=FALSE, eval=FALSE}
include_graphics("images/schema-layer-ggplot2-aes.png")
```
...
```{r g4, echo=FALSE, purl=FALSE, eval=FALSE}
include_graphics("images/schema-layer-ggplot2-layer.png")
```
...
```{r g5, echo=FALSE, purl=FALSE, eval=FALSE}
include_graphics("images/schema-layer-ggplot2-scales.png")
```
...
```{r g6, echo=FALSE, purl=FALSE, eval=FALSE}
include_graphics("images/schema-layer-ggplot2-coord.png")
```
...
```{r g7, echo=FALSE, purl=FALSE, eval=FALSE}
include_graphics("images/schema-layer-ggplot2-coord.png")
```
...
```{r g8, echo=FALSE, purl=FALSE, eval=FALSE}
include_graphics("images/schema-layer-ggplot2-mod.png")
```
