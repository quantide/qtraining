...
## Example: Life data
Let's consider the `life` dataset (see the section *Introduction and datasets used* for further information). The data contains life expectations in 1960 at birth, 25, 50 and 75 years for men and women in 31 Countries or regions. 
...
The first PC seems (negatively) dominated by the mean level of life expectation and, maybe, 
by the life expectancy at birth.  
The second PC, instead, seems to oppose (women?) life expectancy at birth versus life expectancy at
older ages.  
The third PC seems to set adult men against adult-to-old women life expectancy.
...
the mean life expectation within each region drops when the age of subjects grows. This 
...
value in second PC have a lower infant mortality.
...
```
The scatterplot shows that the first two PCs allow to almost perfectly
...
```{r 02b-biplotprincomplife, fig.width=plot_with_legend_fig_width_short}
