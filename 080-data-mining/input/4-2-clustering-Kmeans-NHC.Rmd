...
Now we can try using the XXXX index to help us in finding the optimal number of clusters:
...
Als with this index, not a really clear indication appears on the number of clusters to choose.
...
solution seems to be more interpretable:
